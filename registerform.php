...
<div class="main_menu">
        ...
        <div class="container">
          <div class="banner_content d-md-flex justify-content-between align-items-center">
            <div class="mb-3 mb-md-0">
              ...
              <p>Please finish all information below to become our Customer</p>
            </div>
            <div class="page_link">
  ...
  <div class="row">
    ...
    <div class="col-lg-4 col-md-8" id="signup_msg" style="text-align:center">
    </div>
    <div class="col-md-4"></div>
  </div>
  </div>
  
  <form action="index.php" style="height:1000px;" method="post">
