$(document).ready(function(){
    ...
    $("#btnlogin").click(function(event){
        ...
        $.ajax({
            ...
            success:function(data){
                if(data=="truessssssssssssssssdsadsadsadasdsadas"){
    ...
    $("body").delegate("#btnupdateCart","click",function(e){
        e.preventDefault();
        $(".update").click();
    })
    ...
    $("body").delegate("#detail","click",function(event){
        event.preventDefault();
        var p_id=$(this).attr('pid');
        location.assign("product.php?"+p_id);
    })
    
    $("body").delegate("#btnorder","click",function(event){
        event.preventDefault();
        $.ajax({
            url:"action.php",
            method:"POST",
