...
<div class="main_menu">
  ...
  <div class="thankyou">
      <div class="thanks">
        <h2>Thank you</h2>
        <p>Thank you for ordering. We will check your order and contact you soon!</p>
        <div class="checkout_btn_inner">
                      <a class="gray_btn" href="category.php">Continue Shopping</a>
                      <a class="main_btn" href="order.php">Check your Order</a>
                    </div>
      </div>
